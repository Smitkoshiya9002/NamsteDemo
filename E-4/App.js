...
const resData = [
  {
    ...
    analytics: {
      context: "seo-data-bba16333-6190-42d6-8bdf-dd2edb5ace36",
    },
    cta: {
  ...
  },
  {
    ...
    info: {
      ...
      availability: {
        nextCloseTime: "2025-08-03 22:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
...
const Header = () => {
  return (
    <div className="Header">
      <div className="logo">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0byS4i_Yw5vi8r-Eu-mDk57CMe5kiDI1cTw&"
          alt="logo"
        />
      </div>
